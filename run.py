...
def seed_db():
    ...
    ann = Announcement(title='Welcome to AIMS-FR Portal', content='The new portal is now live with face recognition attendance.', priority='high', target_audience='all')
    db.session.add(ann)
